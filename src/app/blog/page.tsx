    ...
    return (
        <div className="container mx-auto max-w-screen-2xl pb-8 px-4">
            ...
            <section className="relative text-black">
                <Image
                    src="/shop.jpeg" // Update to correct image path
                    alt="Blog Banner"
                    height={400}
                    width={600}
            ...
            <div className="flex flex-col lg:flex-row">
                ...
                <main className="mt-8 w-full lg:w-3/4 gap-6">
                    {/* Blog Posts */}
                    {[
                        { image: "/p4.jpeg", title: "Embracing Millennial Design", category: "Crafts", date: "01 Jan 2023" },
                        { image: "/p3.jpeg", title: "Innovative Decoration Styles", category: "Design", date: "15 Mar 2023" },
                        { image: "/p6.jpeg", title: "Time-Consuming Handmade Art", category: "Wood", date: "20 Sep 2023" },
                    ].map((post, index) => (
                ...
                <aside className="mt-10 w-full lg:w-1/4 p-6 gap-6">
                    ...
                    <section className="p-6 rounded-lg bg-gray-100">
                        ...
                        <div className="space-y-6">
                            {[
                                { image: '/p2.jpeg', title: 'Embracing Millennial Design', date: '03 Aug 2022' },
                                { image: '/p5.jpeg', title: 'Innovative Decoration Styles', date: '03 Aug 2022' },
                                { image: '/p6.jpeg', title: 'Handmade Art', date: '03 Aug 2022' },
                                { image: '/p1.jpeg', title: 'Modern Milan Home', date: '03 Aug 2022' },
                                { image: '/p7.jpeg', title: 'Office Redesign', date: '03 Aug 2022' },
                            ].map((post, index) => (
